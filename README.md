...
# 📖 To Do List <a name="about-project"></a>
 ...
 To-Do List is a simple web application that allows users to manage their tasks. Users can add tasks to the list, mark them as completed, and remove them. The application dynamically updates the task list displayed on the page, allowing users to easily view and interact with their tasks.
...
- **Real-time update of the task list displayed on the page.**
...
```sh
  ...
  git clone git@github.com:JavierAybar/To-Do-List.git
```
...
- **Implement search and filtering functionality for easier navigation of the task list.**
